...
function DetailOrder(props) {
  ...
  useEffect(() => {
    authGet(dispatch, token, "/orders/" + orderId).then((res) => {
      setOrder(res);
              ...
              <Grid xs={8}>
                <div>
                  <div style={{ padding: "0px 30px" }}>
                    ...
                    <b>Total: </b> {checkNull(order["total"])}
                    <p />
                  </div>
                </div>
              </Grid>
