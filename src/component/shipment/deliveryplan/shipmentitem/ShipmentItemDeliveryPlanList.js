...
export default function ShipmentItemDeliveryPlanList() {
  ...
  function getDataTable() {
    authGet(
      dispatch,
      token,
      "/shipment-item-delivery-plan/" + deliveryPlanId + "/all"
    )
      .then((response) => {
  ...
  function handleDelete(shipmentItemId) {
    ...
    authPost(dispatch, token, "/delete-shipment-item-delivery-plan", body)
      .then((response) => {
        if (response.ok) {
            ...
            <div>
              ...
              <Grid container spacing={3}>
                ...
                >
                  <Link
                    to={
                      "/shipment-item-delivery-plan/" + deliveryPlanId + "/add"
                    }
                  >
                    <Button
                      color={"primary"}
