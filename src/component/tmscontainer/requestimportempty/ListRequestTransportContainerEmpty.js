...
function ListRequestTransportContainerEmpty() {
    ...
    return(
        <div>
            <MaterialTable
                title="Danh sách yêu cầu vận chuyển container rỗng từ kho về bãi  "
                columns={columns}
                options={{
                    filtering: true,
                    search: false
                ...
                data={query =>
                    new Promise((resolve, reject) => {
                        ...
                        authGet(
                            dispatch,
                            token,
                            "/get-list-cont-request-import-empty-page"+ "?size=" + query.pageSize + "&page=" + query.page+sortParam+filterParam
                        ).then(
                            res => {
...
export default ListRequestTransportContainerEmpty;