...
function CreateRequestTransportContainerEmpty() {
  ...
  const handleSubmit = event => {
    ...
    authPost(dispatch, token, "/create-request-import-empty", data)
      .then(
        res => {
          console.log(res);
    ...
    <div>
      <MuiPickersUtilsProvider utils={DateFnsUtils}>
        <Card>
          ...
          <CardActions>
            <Link to={"/transport-group/list-request-transport-container-empty"}>
              <Button
...
export default CreateRequestTransportContainerEmpty;
