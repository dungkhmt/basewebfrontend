...
function ListRequestTransportFullExport() {
                ...
                data={query =>
                    new Promise((resolve, reject) => {
                        ...
                        authGet(
                            dispatch,
                            token,
                            "/get-list-cont-request-export-full-page" + "?size=" + query.pageSize + "&page=" + query.page+sortParam+filterParam
                        ).then(
                            res => {
...
export default ListRequestTransportFullExport;