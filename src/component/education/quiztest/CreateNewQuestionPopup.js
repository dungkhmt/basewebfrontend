            ...
            >
                <Grid item xs='auto' >
                    <Card style={{
                        ...
                        <FormGroup row>
                            <FormControlLabel
                                control={<Checkbox checked={yes} onChange={handleChangeCheckBox} name="Đúng" />}
                                label="Đúng"
                                style={{minWidth: '500px'}}
                            />
                            
                            <FormControlLabel
                                control={<Checkbox checked={no} onChange={handleChangeCheckBox} name="Sai" />}
                                label="Sai"
...
function CreateNewQuestionPopup(props) {
    ...
    const handleClose = (e) => {
        setHovered(false);
        if(window.confirm('Bạn muốn thoát và không lưu lại tất cả những gì mình đã nhập ???')) {
            setOpen(false);
        }
    };
            ...
            <Grid item xs='auto' >
                <div onClick={contentClick}>
                    <Card style={{
                        ...
                        {lineBreak}
                        <div style={{ borderTop: "1px solid rgb(0, 0, 0)", marginLeft: "-11%", marginRight: "-11%" }}></div>
                                                ...
                                                <Grid container spacing={1} justify="center">
                                                    ...
                                                    <Grid item xs={3}>
                                                        ...
                                                        >
                                                            ...
                                                            <div style={{display: 'inline', userSelect: "none"}}>
                                                                &#8287;&#8287;&#8287;&#8287;&#8287;&#8287;&#8287;
                                                                &#8287;&#8287;&#8287;&#8287;&#8287;&#8287;&#8287;
                                                                &#8287;
                                                            ...
                                                            <div style={{display: 'inline'}}>
                                                                <Tooltip title="Xóa" aria-label="Xóa">
                                                                    <Button variant="outlined" color="secondary" aria-label="Xóa" size='small' 
                                                                        onClick={(e) => { handleDelete(elm, index); }}>
                                                                        <DeleteIcon />
                                                                    </Button>
                                                                </Tooltip>
                                                            </div>
