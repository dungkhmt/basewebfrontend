...
function CreateChapterMaterialOfCourse(){
    ...
    async function handleSubmit(){
        ...
        let chapter= authPostMultiPart(dispatch, token, "/edu/class/create-chapter-material-of-course", formData).then(
            res => {
                console.log('res = ',res);                
            }
        );
    ...
    async function getCourseChapterMaterialTypeList(){
        let lst = await authGet(dispatch, token,'/edu/class/get-course-chapter-material-type-list');
