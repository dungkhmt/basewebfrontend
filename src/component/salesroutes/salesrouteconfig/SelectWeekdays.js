...
export default function SelectWeekdays({ errors, control, style }) {
  // const classes = useStyles();

  return (
    <FormControl style={style} error={!!errors.days}>
      <InputLabel id="select-weekdays-label">Ngày*</InputLabel>
      <Controller
        as={
          <Select
            multiple
