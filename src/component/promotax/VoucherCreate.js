...
export function VoucherCreate() {
  ...
  async function handleSubmit() {
    ...
    let voucher = await authPost(dispatch, token, '/create-voucher', body).then(r => r.json());
  ...
  return (<div>
    ...
    <Button color={'primary'} variant={'contained'} onClick={() => handleSubmit()}>Tạo mã giảm giá</Button>
  </div>);
}
