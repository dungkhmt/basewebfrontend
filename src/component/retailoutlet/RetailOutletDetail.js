...
function RetailOutletDetail(props) {
    ...
    const [selectedDistributor, setSelectedDistributor] = useState({ distributorName: '' })
    ...
    const columns = [
        {
            ...
            editComponent: () => (  <TextField
                                        ...
                                        label="Nhà phân phối"
                                        onChange={e => setSelectedDistributor({ distributorName: e.target.value })}
                                        style={{
                                            minWidth: '12rem'
                                        }}
                                    >
                ...
                <CardContent>
                    <Toolbar>
                        <div style={{ padding: '0px 30px' }}>
                            ...
                            <b>Tên ĐLBL: </b> {RetailOutletDetail === null ? '' : RetailOutletDetail.retailOutletName} <p />
                            <b>Mã ĐLBL: </b> {RetailOutletDetail === null ? '' : RetailOutletDetail.retailOutletCode} <p />
                        </div>
                    </Toolbar>
                        ...
                        <MaterialTable
                            ...
                            editable={{
                                onRowAdd: (newData) =>
                                    new Promise((resolve) => {
                                        const distributor = DistributorList.find(distributor => distributor.distributorName === selectedDistributor.distributorName)
