  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={CreateTopicOfCourse} path={`${path}/course/detail/topic/create/:courseId`} exact/>
        ...
        <Route component={QuizTestEdit} path={`${path}/class/quiztest/edit/:id`} exact/>
