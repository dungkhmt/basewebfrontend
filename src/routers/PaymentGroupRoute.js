...
import {Payment, PaymentApplication} from "../component/accounting/InvoiceDataTable";
  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={PaymentApplicationCreate} path={`${path}/create-payment-application/:paymentId`}/>
        <Route component={QuickInvoicePayment} path={`${path}/quick-create-payment-application/:invoiceId`}/>
        <Route component={PaymentApplication} path={`${path}/payment-application/:paymentId`}/>
      </Switch>
    </div>
  );
}
