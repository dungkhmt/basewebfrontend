  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={SalesmanFacilityList} exact path={`${path}/salesman/list/:facilityId`}/>
        <Route component={SalesmanFacilityCreate} exact path={`${path}/salesman/create/:facilityId`}/>
