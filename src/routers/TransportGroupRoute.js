  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={CreateRequestTransportContainerToWarehouse}
               path={`${path}/create-request-transport-container-to-warehouse`}/>
        <Route component={ListRequestTransportContainerToWareHouse}
               path={`${path}/list-request-transport-container-to-warehouse`}/>
        <Route component={CreateRequestTransportContainerEmpty}
               path={`${path}/create-request-transport-container-empty`}/>
        <Route component={ListRequestTransportContainerEmpty} path={`${path}/list-request-transport-container-empty`}/>
        <Route component={CreateRequestTransportContainerEmptyExport}
               path={`${path}/create-request-transport-container-empty-export`}/>
        <Route component={ListRequestTransportContainerEmptyExport}
               path={`${path}/list-request-transport-container-empty-export`}/>
        <Route component={CreateRequestTransportFullExport} path={`${path}/create-request-transport-full-export`}/>
        <Route component={ListRequestTransportFullExport} path={`${path}/list-request-transport-full-export`}/>
      </Switch>
    </div>
  );
}
