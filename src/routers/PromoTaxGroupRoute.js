  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={VoucherUpdate} path={`${path}/edit-voucher/:voucherId`}/>
        <Route component={VoucherList} path={`${path}/voucher-list`}/>
        <Route component={VoucherDetail} path={`${path}/voucher-detail/:voucherId`}/>

        <Route component={VoucherRuleCreate} path={`${path}/create-voucher-rule/:voucherId`}/>
        <Route component={VoucherRuleUpdate} path={`${path}/edit-voucher-rule/:voucherId/:voucherRuleId`}/>
