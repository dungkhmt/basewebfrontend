  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={VehicleDetail} path={`${path}/vehicle-detail/:vehicleId`}/>
        <Route component={VehicleNotInDeliveryTrips} path={`${path}/vehicle-not-in-delivery-trips/:deliveryPlanId`}/>
      </Switch>
    </div>
  );
}
