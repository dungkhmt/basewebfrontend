  ...
  return (
    <div>
      <Switch>
        ...
        <Route component={ShipmentItemCreate} path={`${path}/create-shipment-item`}/>
        <Route component={ShipmentItemDeliveryTripDetailList} path={`${path}/shipment-item-info/:shipmentItemId`}/>
        <Route component={NotScheduledShipmentItem} path={`${path}/not-scheduled-shipment-items/:deliveryPlanId`}/>
      </Switch>
    </div>
  );
}
